...
class InspiringPersonAdapter(
    ...
    private val inspiringPeopleListener: InspiringPeopleListener) : BaseAdapter() {

    private var inspiringPeople: MutableList<InspiringPerson>

    init {
        inspiringPeople = PeopleRepository.getListOfInspiringPeople()
    }

    private val inflater: LayoutInflater = this.context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
    override fun getCount(): Int { return inspiringPeople.size }
