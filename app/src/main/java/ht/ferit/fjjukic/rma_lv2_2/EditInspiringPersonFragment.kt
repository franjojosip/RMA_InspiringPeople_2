...
class EditInspiringPersonFragment(
    ...
    override fun onCreateView(
        ...
        if(this.itemId != -1){
            ...
            val inspiringPerson = PeopleRepository.findInspiringPerson(itemId)
            when {
    ...
    private fun setOnClickListener(itemView: View) {
        ...
        this.btnChooseImage.setOnClickListener {
            if (checkSelfPermission(activity!!, android.Manifest.permission.READ_EXTERNAL_STORAGE) ==
